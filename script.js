...
pegarNoticia.open("GET", `http://api.nytimes.com/svc/search/v2/articlesearch.json?q=${buscaPalavra()}&api-key=74af235cde9a43aa9f1f6ad5c0a2bf08`);
...
exibeBusca.innerHTML = `<div class="area-noticia"> ${docs.map(doc =>
 `<div class='noticia'>
